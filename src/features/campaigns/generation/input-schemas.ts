...
export const PlayerCharacterSchema = z.object({
  ...
  characterLevel: z.number().int().positive().default(1),
  notes: z.string(),
...
export const LocationSchema = z.object({
  ...
  status: z
    .enum(["SAFE", "DANGEROUS", "DESTROYED", "OCCUPIED", "UNKNOWN"])
    .default("UNKNOWN"),
...
export const StoryBeatSchema = z.object({
  ...
  storyBeatType: z.enum(["Main Story", "Side Story"]),
...
export type CampaignPromptInput = z.infer<typeof CampaignPromptInputSchema>;
